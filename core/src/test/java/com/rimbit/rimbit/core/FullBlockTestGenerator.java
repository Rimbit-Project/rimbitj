...
import com.rimbit.rimbit.core.Transaction.SigHash;
...
public class FullBlockTestGenerator {
    // Used by RimbitdComparisonTool and AbstractFullPrunedBlockChainTest to create test cases
    ...
    public RuleList getBlocksToTest(boolean addSigExpensiveBlocks, boolean runLargeReorgs, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
            ...
            public boolean add(Rule element) {
                if (outStream != null && element instanceof BlockAndValidity) {
                    try {
                        ...
                        byte[] block = ((BlockAndValidity)element).block.rimbitSerialize();
        ...
        // Extend the b24 chain to make sure rimbitd isn't accepting b24
        ...
        // Extend the b26 chain to make sure rimbitd isn't accepting b26
        ...
        // Extend the b28 chain to make sure rimbitd isn't accepting b28
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.rimbitSerialize());
        ...
        Block b64;
        {
            ...
            for (Transaction transaction : b64Created.getTransactions())
                transaction.rimbitSerialize(stream);
            ...
            Preconditions.checkState(Arrays.equals(stream.toByteArray(), b64.rimbitSerialize()));
        ...
        Block b71 = new Block(params, b72.rimbitSerialize());
