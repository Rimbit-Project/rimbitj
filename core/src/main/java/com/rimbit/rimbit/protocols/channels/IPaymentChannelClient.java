...
import org.rimbit.paymentchannel.Protos;
...
public interface IPaymentChannelClient {
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.rimbit.rimbit.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.rimbit.rimbit.protocols.channels.PaymentChannelCloseException.CloseReason)}
     ...
     * be accepted by the Rimbit network. ValueOutOfRangeException will be thrown, however, if there's not enough money
    ...
    interface ClientConnection {
         ...
         * {@link com.rimbit.rimbit.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link com.rimbit.rimbit.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link com.rimbit.rimbit.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link com.rimbit.rimbit.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link com.rimbit.rimbit.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * {@link com.rimbit.rimbit.protocols.channels.PaymentChannelClient#incrementPayment(java.math.BigInteger)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link com.rimbit.rimbit.protocols.channels.PaymentChannelClient}
