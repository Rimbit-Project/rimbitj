...
public abstract class ServerConnectionEventHandler {
     ...
     * {@link StoredPaymentChannelServerStates#getChannel(com.rimbit.rimbit.core.Sha256Hash)} with the id provided in
     * {@link ServerConnectionEventHandler#channelOpen(com.rimbit.rimbit.core.Sha256Hash)}</p>
     */
