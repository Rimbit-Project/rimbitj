 ...
 * so you can use {@link #calculateBalanceForAddress(com.rimbit.rimbit.core.Address)} to quickly look up
 * the quantity of rimbits controlled by that address.</p>
 */
