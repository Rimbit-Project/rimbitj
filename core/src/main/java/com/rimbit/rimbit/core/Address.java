...
/**
 * <p>A Rimbit address looks like 1MsScoe2fTJoq4ZPdQgqyhgWeoNamYPevy and is derived from an elliptic curve public key
...
public class Address extends VersionedChecksummedBytes {
    ...
    /** The (big endian) 20 byte hash that is the core of a Rimbit address. */
     ...
     * See also https://github.com/rimbit/bips/blob/master/bip-0013.mediawiki: Address Format for pay-to-script-hash
     */
