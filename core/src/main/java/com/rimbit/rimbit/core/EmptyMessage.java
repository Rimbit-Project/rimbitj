 ...
 * Currently this includes getaddr, ping, verack as well as the special rimbitj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void rimbitSerializeToStream(OutputStream stream) throws IOException {
    }
