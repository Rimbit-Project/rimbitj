...
/**
 * <p>A BlockChain implements the <i>simplified payment verification</i> mode of the Rimbit protocol. It is the right
...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link com.rimbit.rimbit.store.SPVBlockStore} or you could also try a
     * {@link com.rimbit.rimbit.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
