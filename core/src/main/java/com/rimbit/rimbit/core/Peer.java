...
/**
 * <p>A Peer handles the high level communication with a Rimbit node, extending a {@link PeerSocketHandler} which
 * handles low-level message (de)serialization.</p>
 *
 * <p>Note that timeouts are handled by the extended
 * {@link com.rimbit.rimbit.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.rimbit.rimbit.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that rimbit-qt is single threaded and processes messages in order.
     ...
     * {@link com.rimbit.rimbit.net.NioClientManager#openConnection(java.net.SocketAddress, com.rimbit.rimbit.net.StreamParser)}
     * or
     * {@link com.rimbit.rimbit.net.NioClient#NioClient(java.net.SocketAddress, com.rimbit.rimbit.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // rimbitj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public void setDownloadParameters(long secondsSinceEpoch, boolean useFilteredBlocks) {
    	// For rimbit we cannot use filtered blocks until the protocol has been upgraded
        lock.lock();
        try {
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) {
        ...
        //
        //   https://en.rimbit.it/wiki/Protocol_specification#getblocks
        //
     ...
     * Once the pong is received the value returned by {@link com.rimbit.rimbit.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.rimbit.rimbit.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.rimbit.rimbit.core.Peer#ping()} has never
