...
/**
 * <p>Methods to serialize and de-serialize messages to the Rimbit network format as defined in
 * <a href="https://en.rimbit.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.rimbitSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class RimbitSerializer {
    private static final Logger log = LoggerFactory.getLogger(RimbitSerializer.class);
    ...
    /**
     * Constructs a RimbitSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public RimbitSerializer(NetworkParameters params) {
     ...
     */
    public RimbitSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("RimbitSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.rimbitSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Rimbit protocol message has the following format.
        //
        ...
        RimbitPacketHeader header = new RimbitPacketHeader(in);
     ...
     */
    public RimbitPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new RimbitPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link RimbitSerializer#deserializeHeader}.
     */
    public Message deserializePayload(RimbitPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class RimbitPacketHeader {
        ...
        public RimbitPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
