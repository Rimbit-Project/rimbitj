...
public class VersionMessage extends Message {
    ...
    public static final String RimbitJ_VERSION = "0.11.4";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/RimbitJ:" + RimbitJ_VERSION + "/";
    ...
    @Override
    public void rimbitSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.rimbitSerialize(buf);
            // Their address.
            theirAddr.rimbitSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for RimbitJ
     * users might look like "/RimbitJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/RimbitJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://github.com/rimbit/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.
     *
