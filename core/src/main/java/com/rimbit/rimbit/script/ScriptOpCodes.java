...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Rimbit protocol.
 * See {@link com.rimbit.rimbit.script.Script} for details. Also provides a method to convert them to a string.
 */
