...
/**
 * Network parameters used by the rimbitj unit tests (and potentially your own). This lets you solve a block using
 * {@link com.rimbit.rimbit.core.Block#solve()} by setting difficulty to the easiest possible.
 */
