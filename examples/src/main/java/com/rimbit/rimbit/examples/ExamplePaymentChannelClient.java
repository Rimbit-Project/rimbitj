...
import com.rimbit.rimbit.protocols.channels.PaymentChannelClientConnection;
import com.rimbit.rimbit.protocols.channels.StoredPaymentChannelClientStates;
import com.rimbit.rimbit.protocols.channels.ValueOutOfRangeException;
...
import static com.rimbit.rimbit.core.Utils.CENT;
...
public class ExamplePaymentChannelClient {
    ...
    private void waitForSufficientBalance(BigInteger amount) {
        ...
        if (!balanceFuture.isDone()) {
            System.out.println("Please send " + Utils.rimbitValueToFriendlyString(amountPlusFee) +
